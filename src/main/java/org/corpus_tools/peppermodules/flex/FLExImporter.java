...
public class FLExImporter extends PepperImporterImpl implements PepperImporter{
	 ...
	 * sample mapper of type {@link FLExMapper}, which only produces a fixed
	 * document-structure in method {@link FLExMapper#mapSDocument()} and
	 * enhances the corpora for further meta-annotations in the method
	 * {@link FLExMapper#mapSCorpus()}. <br/>
	 ...
	 * {@link FLExMapper#mapSDocument()} and enhances the corpora for further
	 * meta-annotations in the method {@link FLExMapper#mapSCorpus()}. <br/>
	 ...
	 *
	 */
	public static class FLExMapper extends PepperMapperImpl {
		/**
		 * <strong>OVERRIDE THIS METHOD FOR CUSTOMIZATION</strong> <br/>
